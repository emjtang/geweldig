...
def main(args):
  ...
  for epoch in range(args.num_epochs1):
    ...
    print()
    f.write(str(epoch) + "," + str(1e-3) + "," + str(train_acc) + "," + str(val_acc) + "\n")
  ...
  for epoch in range(args.num_epochs2):
    ...
    print('Val accuracy: ', val_acc)
    print()
    f.write(str(epoch) + "," + str(1e-5) + "," + str(train_acc) + "," + str(val_acc) + "\n")
  torch.save(model, "pytorch_full")
